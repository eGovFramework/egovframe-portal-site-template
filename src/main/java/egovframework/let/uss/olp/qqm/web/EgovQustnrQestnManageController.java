...
public class EgovQustnrQestnManageController {
	...
	public String EgovQustnrQestnManageStatistics(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			QustnrQestnManageVO qustnrQestnManageVO, @RequestParam Map<String, Object> commandMap, ModelMap model)
			throws Exception {
		...
		// List statisticsList =
		// egovQustnrQestnManageService.selectQustnrManageStatistics(mapParam);
		model.addAttribute("statisticsList", egovQustnrQestnManageService.selectQustnrManageStatistics(mapParam));
		// 주관식설문통계
		// List statisticsList2 =
		// egovQustnrQestnManageService.selectQustnrManageStatistics2(mapParam);
	...
	public String EgovQustnrQestnManageListPopup(@ModelAttribute("searchVO") ComDefaultVO searchVO,
	...
	public String EgovQustnrQestnManageList(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@ModelAttribute("qustnrQestnManageVO") QustnrQestnManageVO qustnrQestnManageVO,
			@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
	...
	public String EgovQustnrQestnManageDetail(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@ModelAttribute("qustnrQestnManageVO") QustnrQestnManageVO qustnrQestnManageVO,
			@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
	...
	public String QustnrQestnManageModify(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@RequestParam Map<String, Object> commandMap,
			@ModelAttribute("qustnrQestnManageVO") QustnrQestnManageVO qustnrQestnManageVO, BindingResult bindingResult,
		...
		if (sCmd.equals("save")) {
			...
			if (bindingResult.hasErrors()) {
				...
				String sQestnrTmplatId = commandMap.get("qestnrTmplatId") == null ? ""
	...
	public String QustnrQestnManageRegist(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@RequestParam Map<String, Object> commandMap,
			@ModelAttribute("qustnrQestnManageVO") QustnrQestnManageVO qustnrQestnManageVO, BindingResult bindingResult,
			ModelMap model) throws Exception {
		// 0. Spring Security 사용자권한 처리
