...
public class EgovQustnrManageController {
	...
	public String EgovQustnrManageListPopup(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@RequestParam Map<String, Object> commandMap, QustnrManageVO qustnrManageVO, ModelMap model)
			throws Exception {
	...
	public String EgovQustnrManageDetail(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			QustnrManageVO qustnrManageVO, @RequestParam Map<String, Object> commandMap, ModelMap model)
			throws Exception {
	...
	public String QustnrManageModify(@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@RequestParam Map<String, Object> commandMap, QustnrManageVO qustnrManageVO, BindingResult bindingResult,
	...
	public String QustnrManageRegist(@ModelAttribute("searchVO") ComDefaultVO searchVO,
		...
		if (sCmd.equals("save")) {
			...
			model.addAttribute("listQustnrTmplat",
					egovQustnrManageService.selectQustnrTmplatManageList(qustnrManageVO));
			// System.out.println("???:::" +
			// (egovQustnrManageService.selectQustnrTmplatManageList(qustnrManageVO)).get(0));
		}
