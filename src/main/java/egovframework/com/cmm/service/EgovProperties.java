...
/**
 * Class Name : EgovProperties.java Description : properties값들을 파일로부터 읽어와   Globals클래스의 정적변수로 로드시켜주는 클래스로 문자열 정보 기준으로
 * 사용할 전역변수를 시스템 재시작으로 반영할 수 있도록 한다. Modification Information
 * <p>
 * 수정일         수정자                   수정내용 -------    --------    --------------------------- 2009.01.19    박지욱
 * 최초 생성 2011.07.20    서준식 	      Globals파일의 상대경로를 읽은 메서드 추가 2011.08.31  JJY            경량환경 템플릿 커스터마이징버전 생성
 *
