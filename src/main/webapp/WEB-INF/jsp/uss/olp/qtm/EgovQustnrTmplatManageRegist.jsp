                    ...
                    <div class="layout">
                        ...
                        <div class="content_wrap">
                            <div id="contents" class="content">
								...
								<form:form modelAttribute="qustnrTmplatManageVO"  name="qustnrTmplatManageVO" action="${pageContext.request.contextPath}/uss/olp/qtm/EgovQustnrTmplatManageRegistActor.do" method="post" enctype="multipart/form-data">
                                ...
                                <div class="board_view2">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:input id="qestnrTmplatTy" path="qestnrTmplatTy" size="70" class="f_txt w_full" maxlength="100" title="템플릿유형 입력" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input id="qestnrTmplatImage" class="f_file" type="file" name="qestnrTmplatImage" onChange="fnImgChange(this)" title="템플릿유형이미지 선택" />
                                                <p class="txt_3">가로 : 65px, 세로 : 50px, 포멧 : JPEG 형식으로 업로드 해주세요</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="lb">
                                            ...
                                            <td>
                                                <form:textarea id="qestnrTmplatCn" path="qestnrTmplatCn" rows="10" cols="30" class="f_txtar w_full h_80" title="템플릿설명 입력"/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form:input id="qestnrTmplatCours" path="qestnrTmplatCours" size="70" class="f_txt w_full" maxlength="100" title="템플릿경록 입력"/>
