                                        ...
                                        <tr>
                                            ...
                                            <td class="rdoSet"><!-- 2개이상 radio 있을때 필요 -->
                                            	<c:forEach items="${listQustnrTmplat}" var="resultQustnrTmplat" varStatus="status">
                                                	<img class="vam mr5" src="<c:out value="${pageContext.request.contextPath}"/>uss/olp/qtm/EgovQustnrTmplatManageImg.do?qestnrTmplatId=${resultQustnrTmplat.qestnrTmplatId}" alt="템플릿유형 이미지" title="템플릿유형 이미지" style="width: 65px; height: 50px;">
