                            ...
                            <div id="contents" class="content">
                                ...
                                <div class="condition">
                                	...
                                	<form name="QnaListForm" action="<c:url value='/uss/olh/qna/QnaListInqire.do'/>" method="post">
	                                    ...
	                                    <a href="<c:url value='/uss/olh/qna/QnaCnRegistView.do'/>" class="item btn btn_blue_46 w_100" onclick="fn_egov_regist_cnsltcn(); return false;"><spring:message code="button.create" /></a><!-- 등록 -->
