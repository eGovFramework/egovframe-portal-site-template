                                    ...
                                    <table summary="Q&amp;A에 대한 답변목록을 제공합니다.">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="al">
                                                	<a href="<c:url value='/uss/olh/qnm/QnaAnswerDetailInqire.do'/>?qaId=${egovc:encrypt(resultInfo.qaId)}&amp;pageIndex=${searchVO.pageIndex}" class="lnk" onclick="fn_egov_inquire_qnaanswerdetail('<c:out value="${egovc:encrypt(resultInfo.qaId)}"/>'); return false;">
