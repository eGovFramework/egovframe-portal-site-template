                                ...
                                <div class="board_view">
                                    ...
                                    <div class="board_view_bot">
                                        ...
                                        <div class="right_col btn1">
                                            <a href="<c:url value='/uss/olh/faq/FaqListInqire.do'/>" class="btn btn_blue_46 w_100" onclick="fn_egov_inqire_faqlist(); return false;"><spring:message code="button.list" /></a><!-- 목록 -->
                                        </div>
                                    </div>
                                    <!-- 목록/저장버튼  끝-->
                                </div>
