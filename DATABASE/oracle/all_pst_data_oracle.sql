...
INSERT INTO LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) VALUES ('cop-bbs','cop-bbs','/cop/bbs/(select|anonymous|preview|Select|insertGuest|selectGuest|deleteGuest|updateGuest).*\\.do.*','게시판','url','2',SYSDATE);
...
INSERT INTO LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) VALUES ('uss-olh-faq','uss-olh-faq','/uss/olh/faq/(EgovMain|EgovLeft|FaqListInqire|FaqListDetailInqire|FaqInqireCoUpdt)\\.do.*','FAQ','url','9',SYSDATE);
INSERT INTO LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) VALUES ('uss-olh-faq-admin','uss-olh-faq-admin','/uss/olh/faq/(FaqCnRegist|FaqCnUpdt|FaqCnDelete|admin).*\\.do.*','FAQ관리','url','0',SYSDATE);
INSERT INTO LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) VALUES ('cmm-fms-read','cmm-fms-read','/cmm/fms/selectFileInfs.do','파일목록조회','url','0',SYSDATE);
INSERT INTO LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) VALUES ('cmm-fms','cmm-fms','/cmm/fms/.*.do.*','파일관리','url','1',SYSDATE);
INSERT INTO LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) VALUES ('uss-olh-qna','uss-olh-qna','/uss/olh/qna/(EgovMain|EgovLeft|QnaListInqire|QnaDetailInqire|QnaInqireCoUpdt|LoginRealnmChoice)\\.do.*','QnA','url','10',SYSDATE);
INSERT INTO LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) VALUES ('uss-olh-qna-write','uss-olh-qna-write','/uss/olh/qna/(QnaCnRegist|QnaPasswordConfirm|QnaCnUpdt|QnaCnDelete).*\\.do.*','QnA작성','url','0',SYSDATE);
INSERT INTO LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) VALUES ('uss-olh-qna-admin','uss-olh-qna-admin','/uss/olh/qna/admin/.*\\.do.*','QnA관리','url','1',SYSDATE);
INSERT INTO LETTNROLEINFO(ROLE_CODE,ROLE_NM,ROLE_PTTRN,ROLE_DC,ROLE_TY,ROLE_SORT,ROLE_CREAT_DE) VALUES ('uss-olh-qnm-admin','uss-olh-qnm-admin','/uss/olh/qnm/admin/.*\\.do.*','QnA답변관리','url','2',SYSDATE);
...
INSERT INTO LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) VALUES ('ROLE_ADMIN','uss-olh-faq-admin',SYSDATE);
INSERT INTO LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) VALUES ('ROLE_ANONYMOUS','cmm-fms-read',SYSDATE);
INSERT INTO LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) VALUES ('ROLE_USER_MEMBER','cmm-fms',SYSDATE);
INSERT INTO LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) VALUES ('ROLE_USER_MEMBER','uss-olh-qna-write',SYSDATE);
INSERT INTO LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) VALUES ('ROLE_ADMIN','uss-olh-qna-admin',SYSDATE);
INSERT INTO LETTNAUTHORROLERELATE(AUTHOR_CODE,ROLE_CODE,CREAT_DT) VALUES ('ROLE_ADMIN','uss-olh-qnm-admin',SYSDATE);
...
INSERT INTO LETTNGNRLMBER(MBER_ID,PASSWORD,PASSWORD_HINT,PASSWORD_CNSR,IHIDNUM,MBER_NM,ZIP,ADRES,AREA_NO,MBER_STTUS,DETAIL_ADRES,END_TELNO,MBTLNUM,GROUP_ID,MBER_FXNUM,MBER_EMAIL_ADRES,MIDDLE_TELNO,SBSCRB_DE,SEXDSTN_CODE,ESNTL_ID) VALUES ('user2','j6s6YFd779dlzeg/JzfNGp8lpyNWyUBSwhlOgWgpszE=','P01','123','','회원2','','','','P','','','','GROUP_00000000000000','','','',SYSDATE,'','USRCNFRM_00000000002');
...
INSERT INTO LETTNEMPLYRSCRTYESTBS(SCRTY_DTRMN_TRGET_ID,MBER_TY_CODE,AUTHOR_CODE) VALUES ('USRCNFRM_00000000002','GNR','ROLE_USER_MEMBER');
